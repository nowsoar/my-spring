package github.nowsoar.springframework.beans.factory.xml;
...
import github.nowsoar.springframework.beans.factory.support.AbstractBeanDefinitionReader;
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
        ...
        for (int i = 0; i < childNodes.getLength(); i ++) {
            ...
            if (getRegistry().containsBeanDefinition(beanName)) {
                throw new BeansException("Duplicate beanNem [" + beanName + "] is not allowed");
            }
